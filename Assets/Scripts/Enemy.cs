...
public class Enemy : MonoBehaviour
{
    ...
    private void Chasing()
    {
        ...
        GameObject.Find("GameManager").GetComponent<GameManager>().isChased = true;
    ...
    {
        GameObject.Find("GameManager").GetComponent<GameManager>().isChased = false;
        music.idleMusic();
